...
namespace CmsHeadless.Migrations
{
    ...
    [Migration("20220801134958_Token_Expiration")]
    partial class Token_Expiration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CmsHeadless.Models.AuthTokens", b =>
                {
            ...
            modelBuilder.Entity("CmsHeadless.Models.CmsUser", b =>
                {
                    ...
                    b.Property<string>("AuthTokensUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CmsHeadless.Models.CmsUser", b =>
                {
                    b.HasOne("CmsHeadless.Models.AuthTokens", "AuthTokens")
                        .WithMany()
                        .HasForeignKey("AuthTokensUserId");
            ...
            modelBuilder.Entity("CmsHeadless.Models.Content", b =>
                {
                    b.HasOne("CmsHeadless.Models.CmsUser", "User")
                        .WithMany("Content")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CmsHeadless.Models.CmsUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
